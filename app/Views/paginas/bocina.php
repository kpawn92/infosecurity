...
<div class="preloader flex-column justify-content-center align-items-center">
    <h1 class="modal-title" id="exampleModalLabel">Speaker</h1>
...
<!-- Modal Eliminar SPEAKER-->
<div class="modal fade validate" id="delbocina" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/del_bocina") ?>">
...
<div class="modal fade validate" id="upbocina" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/up_bocina") ?>">
                    <div class="form-group">
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada de la speaker</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: dimgray;" href="#lbocina">Bocinas</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario para el registro de la speaker</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="<?= site_url("/reg_bocina") ?>" id="quickForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                                <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" name="fecha" placeholder="mm/dd/YYYY" />
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn" name="btn-bocina" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row" id="lbocina">
                            <span>Listado de speaker registradas</span>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php $i = 1; ?>
                        <table id="bocinas" class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
                            ...
                            <tbody>
                                <?php foreach ($bocinas as $bocina) : ?>
                                    <tr>
                                        <th><?= $i++ ?></th>
                                        <td class="action">
                                            <button type="button" data-toggle="modal" data-target="#delbocina" data-id="<?= $bocina['id'] ?>" class="btn btn-danger btn-single btn-sm fa-input"><i class="fas fa-trash-alt"></i></button>
                                            <button type="button" data-toggle="modal" data-target="#upbocina" data-id="<?= $bocina['id'] ?>" class="btn btn-info btn-single btn-sm fa-input"><i class="fas fa-edit"></i></button>
                                        </td>
                                        <td><?= $bocina['nombrepc'] . " - " . $bocina['inventario'] ?></td>
                                        <td><?= $bocina['inv'] ?></td>
                                        <td><?= $bocina['marca'] ?></td>
                                        <td><?= $bocina['modelo'] ?></td>
                                        <td><?= $bocina['ns'] ?></td>
...
<script>
    $(document).ready(function() {
        ...
        $('#delbocina').on('show.bs.modal', function(e) {
            var id = $(e.relatedTarget).data('id');
            $("#idmodal").val(id);
        });

        $('#upbocina').on('show.bs.modal', function(e) {
            var id = $(e.relatedTarget).data('id');
            $("#idmodal2").val(id);
        });
        ...
        }).buttons().container().appendTo('#bocinas_wrapper .col-md-6:eq(0)');
