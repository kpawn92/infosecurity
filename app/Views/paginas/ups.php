...
<div class="preloader flex-column justify-content-center align-items-center">
    <h1 class="modal-title" id="exampleModalLabel">UPS</h1>
...
<!-- Modal Eliminar UPS-->
<div class="modal fade validate" id="delups" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/del_ups") ?>">
...
<div class="modal fade validate" id="ups" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/up_ups") ?>">
                    <div class="form-group">
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada de la UPS</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: dimgray;" href="#lups">UPS</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario para el registro de la UPS</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="<?= site_url("/reg_ups") ?>" id="quickForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn" name="btn-ups" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row" id="lups">
                            <span>Listado de UPS registrados</span>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php $i = 1; ?>
                        <table id="baterias" class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
                            ...
                            <tbody>
                                <?php foreach ($baterias as $ups) : ?>
                                    <tr>
                                        <th><?= $i++ ?></th>
                                        <td class="action">
                                            <button type="button" data-toggle="modal" data-target="#delups" data-id="<?= $ups['id'] ?>" class="btn btn-danger btn-single btn-sm fa-input"><i class="fas fa-trash-alt"></i></button>
                                            <button type="button" data-toggle="modal" data-target="#ups" data-id="<?= $ups['id'] ?>" class="btn btn-info btn-single btn-sm fa-input"><i class="fas fa-edit"></i></button>
                                        </td>
                                        <td><?= $ups['nombrepc'] . " - " . $ups['inventario'] ?></td>
                                        <td><?= $ups['inv'] ?></td>
                                        <td><?= $ups['marca'] ?></td>
                                        <td><?= $ups['modelo'] ?></td>
                                        <td>
...
<script>
    $(document).ready(function() {
        ...
        $('#delups').on('show.bs.modal', function(e) {
            var id = $(e.relatedTarget).data('id');
            $("#idmodal").val(id);
        });

        $('#ups').on('show.bs.modal', function(e) {
            var id = $(e.relatedTarget).data('id');
            $("#idmodal2").val(id);
        });
        ...
        }).buttons().container().appendTo('#baterias_wrapper .col-md-6:eq(0)');
