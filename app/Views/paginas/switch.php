...
<div class="preloader flex-column justify-content-center align-items-center">
    <h1 class="modal-title" id="exampleModalLabel">Switch</h1>
...
<div class="modal fade validate" id="delswitch" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/del_switch") ?>">
...
<div class="modal fade validate" id="update" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/up_switch") ?>">
                    <div class="form-group">
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada del switch</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: dimgray;" href="#lswitch">Switch</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario para el registro del switch</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="<?= site_url("/reg_switch") ?>" id="quickForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" id="programable" name="programable">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn" name="btn-switch" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row" id="lswitch">
                            <span>Listado de switch registrados</span>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php $i = 1; ?>
                        <table id="switchs" class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
                            ...
                            <tbody>
                                <?php foreach ($interruptores as $switch) : ?>
                                    <tr>
                                        <th><?= $i++ ?></th>
                                        <td class="action">
                                            <button type="button" data-toggle="modal" data-target="#delswitch" data-id="<?= $switch['id'] ?>" class="btn btn-danger btn-single btn-sm fa-input"><i class="fas fa-trash-alt"></i></button>
                                            <button type="button" data-toggle="modal" data-target="#update" data-id="<?= $switch['id'] ?>" class="btn btn-info btn-single btn-sm fa-input"><i class="fas fa-edit"></i></button>
                                        </td>
                                        <td><?= $switch['nombre'] . "  " . $switch['lastname'] . " - " . $switch['cargo'] ?></td>
                                        <td><?= $switch['dpto'] ?></td>
                                        <td><?= $switch['inventario'] ?></td>
                                        <td><?= $switch['marca'] ?></td>
                                        <td><?= $switch['modelo'] ?></td>
                                        <td><?= $switch['ns'] ?></td>
                                        <td>
                                            <?php
                                            $estado = $switch['programable'];
                                            if ($estado == 1) {
                                                echo "SI";
                                            } else if ($estado == 2) {
                                                echo "NO";
...
<script>
    $(document).ready(function() {
        ...
        $('#delswitch').on('show.bs.modal', function(e) {
        ...
        }).buttons().container().appendTo('#switchs_wrapper .col-md-6:eq(0)');
