...
<div class="preloader flex-column justify-content-center align-items-center">
    <h1 class="modal-title" id="exampleModalLabel">Modem</h1>
...
<div class="modal fade validate" id="delmodem" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/del_modem") ?>">
...
<div class="modal fade validate" id="upmodem" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url("/up_modem") ?>">
                    <div class="form-group">
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada del modem</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: dimgray;" href="#lmodem">Modem</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario para el registro del modem</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="<?= site_url("/reg_modem") ?>" id="quickForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn" name="btn-modem" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row" id="lmodem">
                            <span>Listado de modems registrados</span>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php $i = 1; ?>
                        <table id="modems" class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acci&oacute;n</th>
                            ...
                            <tbody>
                                <?php foreach ($modems as $modem) : ?>
                                    <tr>
                                        <th><?= $i++ ?></th>
                                        <td class="action">
                                            <button type="button" data-toggle="modal" data-target="#delmodem" data-id="<?= $modem['id'] ?>" class="btn btn-danger btn-single btn-sm fa-input"><i class="fas fa-trash-alt"></i></button>
                                            <button type="button" data-toggle="modal" data-target="#upmodem" data-id="<?= $modem['id'] ?>" class="btn btn-info btn-single btn-sm fa-input"><i class="fas fa-edit"></i></button>
                                        </td>
                                        <td><?= $modem['nombre'] . "  " . $modem['lastname'] . " - " . $modem['cargo'] ?></td>
                                        <td><?= $modem['dpto'] ?></td>
                                        <td><?= $modem['inventario'] ?></td>
                                        <td><?= $modem['marca'] ?></td>
                                        <td><?= $modem['modelo'] ?></td>
                                        <td>
                                            <?php
...
<script>
    $(document).ready(function() {
        ...
        $('#delmodem').on('show.bs.modal', function(e) {
            var id = $(e.relatedTarget).data('id');
            $("#idmodal").val(id);
        });

        $('#upmodem').on('show.bs.modal', function(e) {
            var id = $(e.relatedTarget).data('id');
            $("#idmodal2").val(id);
        });
        ...
        }).buttons().container().appendTo('#modems_wrapper .col-md-6:eq(0)');
