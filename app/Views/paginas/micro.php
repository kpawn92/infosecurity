...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada del microprocesador</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: dimgray;" href="#microp">Microprocesador</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario para el registro del microprocesador</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="<?= site_url("/reg_micro") ?>" id="quickForm">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="velocidad" name="velocidad" placeholder="Entre la velocidad">
                                        </div>
                                        <div class="form-group">
                                            <label for="cantnucleos">Cantidad de n&uacute;cleos:</label>
                                            <input type="text" class="form-control" id="cantnucleos" name="cantnucleos" placeholder="Entre la cantidad de nucleos">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn" name="btn-micro" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row" id="microp">
                            <span>Listado de microprocesadores registrados</span>
                        </div>
