...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada del monitor</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: dimgray;" href="#ldisplay">Monitor</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario para el registro del monitor</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="<?= site_url("/reg_monitor") ?>" id="quickForm">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pulgadas" name="pulgadas" placeholder="Entre la cantidad">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn" name="btn-monitor" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
