...
<div class="preloader flex-column justify-content-center align-items-center">
    <h1 class="modal-title" id="exampleModalLabel">Teclado</h1>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: dimgray;" href="#lteclado">Teclado</a></li>
                    ...
                    <div class="card card-success">
                        ...
                        <form method="POST" action="<?= site_url("/reg_teclado") ?>" id="quickForm">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="interfaz" name="interfaz" placeholder="Tipo de interfaz" list="lista">
                                            <datalist id="lista">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn" name="btn-teclado" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
